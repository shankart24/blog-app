			...
			<div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
				<div className="md:max-w-md lg:col-span-2">
					<div className="flex space-x-2 items-center">
						{/* <img
							src={
								"https://e7.pngegg.com/pngimages/691/500/png-clipart-logo-organization-geometric-shapes-blue-angle.png"
							}
							className="w-18 h-8 rounded-full"
						/> */}
						<span className="font-bold text-2xl text-customPink">Bloggy</span>
					</div>
